  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
      ...
      function showError(input, message) {
        ...
        error.style.cssText = 'color:#dc3545;font-size:0.85em;margin-top:4px;display:block;';
      ...
      function validateField(input) {
        ...
        if (value && type === 'tel' && !phoneRegex.test(value)) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '62bf8cb8-732a-4b8e-817c-7896c9231abb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '62bf8cb8-732a-4b8e-817c-7896c9231abb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '62bf8cb8-732a-4b8e-817c-7896c9231abb';
